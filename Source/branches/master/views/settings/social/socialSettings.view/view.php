...
foreach ($socials as $social)
{
	...
	$attr = array();
	$attr['type'] = $social;
	$actionFactory->setAction($uaction, "settings/social/socialCredentialsDialog", "", $attr);
	...
	$switchObject = $switch->build("", $enabled)->engageApp("settings/social/socialStatusToggle", $swAttr)->get();
	$row[] = $switchObject;
