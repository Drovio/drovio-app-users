...
DOM::append($activeSessionsContainer, $sessionList);
...
$activeSessions = accountSession::getInstance()->getActiveSessions($_GET['aid']);
if ($activeSessions != NULL && count($activeSessions) > 0) {
	foreach ($activeSessions as $session) {
		...
		$ip = HTML::create("div", $session["location"], "", "info-cell");
