...
{
	// Log error
	logger::getInstance()->log("API key is not valid. Post fields:", logger::ERROR, $_POST);
...
{
	// Log error
	logger::getInstance()->log("Registration email is not valid. Aborting. Post fields:", logger::ERROR, $_POST);
...
if (!$status)
{
	...
	{
		// Log error
		logger::getInstance()->log("The email provided already exists in the database. Aborting. Post fields:", logger::ERROR, $_POST);
