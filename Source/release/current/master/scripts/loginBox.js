...
lgbx_url = {
	...
	removeVar : function(hrf, vrb) {
		...
		// Remove variable using regex pattern
...
window.loginBox.options = jq.extend(__loginBox.options, window.loginBox.options);
window.loginBox = jq.extend(__loginBox, window.loginBox);
