...
// Set url prefix
$apiURL = "https://api.drov.io/apps/".$applicationID."/".$privateKey."/";
...
// Set url prefix
$apiURLOption = HTML::select(".demo_api_url option")->item(0);
HTML::attr($apiURLOption, "value", $apiURL);
