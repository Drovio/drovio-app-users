...
$loginForm = $form->build($action = "https://api.drov.io/apps/loginBox/".$publicKey."/api/login", $defaultButtons = FALSE, $async = TRUE)->get();
...
$registerForm = $form->build($action = "https://api.drov.io/apps/loginBox/".$publicKey."/api/register", $defaultButtons = FALSE, $async = TRUE)->get();
...
$recoverForm = $form->build($action = "https://api.drov.io/apps/loginBox/".$publicKey."/api/recoverPassword", $defaultButtons = FALSE, $async = TRUE)->get();
...
$recoverForm = $form->build($action = "https://api.drov.io/apps/loginBox/".$publicKey."/api/account/updatePasswordFromReset", $defaultButtons = FALSE, $async = TRUE)->get();
DOM::append($formContainer, $recoverForm);
// Set role
