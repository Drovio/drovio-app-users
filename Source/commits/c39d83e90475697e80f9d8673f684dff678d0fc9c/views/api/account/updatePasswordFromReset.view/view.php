...
$status = account::getAPIInstance()->updatePasswordByReset($resetID, $newPassword);
if (!$status)
{
	// Show error
	$info = array();
...
else
{
	...
	//appMail::sentMailTemplate($accountInfo['mail'], $templateName = "passwordResetNotification");
