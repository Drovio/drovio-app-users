...
{
	// Log error
	logger::getInstance()->log("Registration email '".$email."' already exists in the database.", logger::ERROR);
...
if (!$status)
{
	...
	{
		// Log error
		logger::getInstance()->log("Registration: The email [".$email."] already exists in the database. Aborting.", logger::ERROR);
