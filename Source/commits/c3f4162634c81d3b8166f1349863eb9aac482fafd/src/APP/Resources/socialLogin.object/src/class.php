 ...
 * @updated	November 20, 2015, 19:22 (GMT)
 */
...
{	
	 ...
	 * 
	 * @return	mixed
	 * 		FALSE if construction fails, or the url if successful.
	 */
	public function getRedirectUri() {
		...
		switch ($this->loginType) {
			case "facebook" :
				return "https://api.drov.io/dev/apps/".$appId."/".$publicKey."/api/social/facebookLogin";
			default :
				return FALSE;
		}
	}
